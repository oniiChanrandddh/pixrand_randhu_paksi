...
<div class="page-wrapper">
    ...
    <h1 class="title-main">Tambah Foto Publik</h1>
    <p class="subtitle-main">Admin hanya dapat menambahkan foto ke album publik</p>

    <div class="panel">
        <form action="../actions/photo_create.php" method="POST" enctype="multipart/form-data" class="form-grid">

            <div class="form-group">
                <label>Judul Foto <span class="required">*</span></label>
                <input type="text" name="title" class="form-input" placeholder="Masukkan judul foto" required maxlength="100">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="file-wrapper">
                    <button type="button" class="file-btn" id="fileTrigger">Pilih Foto</button>
            ...
            <div class="form-group">
                <label>Pilih Album Publik <span class="required">*</span></label>

                <div class="custom-select-album" id="albumSelectBox">
                    <div class="custom-select-selected">Pilih Album Publik</div>
            ...
            <div class="form-group">
                ...
                <textarea name="caption" placeholder="Tambahkan deskripsi foto..." maxlength="255"></textarea>
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-primary">
                    <i data-feather="check"></i> Simpan Foto
                </button>
            </div>
